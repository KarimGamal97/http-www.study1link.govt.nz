...
window.alert(`Thank you for participating in this pharming awareness experiment
...
const errors = [err1, err2, err3, err4, err5, err6, err7, err8];
let isStartBtnClicked = false;
let points = 0;
let pointsPercentage = (points / 8) * 100;
